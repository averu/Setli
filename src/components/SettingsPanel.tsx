    ...
    <div className={styles.settingsPanel}>
      <div className={styles.settingsGroup}>
        ...
        <div className={styles.settingsInput}>
          <input type='text' value={settings.sceneName} onChange={handleChange('sceneName')} />
        </div>
      </div>
      <div className={styles.settingsGroup}>
        ...
        <div className={styles.settingsInput}>
          ...
          <input type='color' value={settings.fontColor} onChange={handleChange('fontColor')} />
        </div>
      </div>
      <div className={styles.settingsGroup}>
      ...
      <div className={styles.settingsGroup}>
        ...
        <div className={styles.settingsInput}>
          <Toggle checked={settings.outline} onChange={handleCheckboxChange('outline')} />
        </div>
      </div>
      <div className={styles.settingsGroup}>
      ...
      <div className={styles.settingsGroup}>
        ...
        <div className={styles.settingsInput}>
          ...
          <input type='color' value={settings.outlineColor} onChange={handleChange('outlineColor')} />
        </div>
      </div>
      <div className={styles.settingsGroup}>
